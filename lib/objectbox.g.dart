...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 4149356290691389468),
      name: 'Group',
      lastPropertyId: const obx_int.IdUid(3, 4898116023663972496),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 8377087734878246378),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 2659957455474895167),
            name: 'name',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 4898116023663972496),
            name: 'color',
            type: 6,
            flags: 0)
      ],
  ...
  obx_int.ModelEntity(
      id: const obx_int.IdUid(2, 828795329523702776),
      name: 'Task',
      lastPropertyId: const obx_int.IdUid(4, 8324663033998411386),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 5857642070565733981),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 7098943723338691502),
            name: 'description',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 1329602448934994944),
            name: 'completed',
            type: 1,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 8324663033998411386),
            name: 'groupId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(1, 7861903120602299167),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(2, 828795329523702776),
      lastIndexId: const obx_int.IdUid(1, 7861903120602299167),
